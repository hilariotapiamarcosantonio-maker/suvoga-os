...
export function Footer() {
  return (
    <footer className="border-t border-[#D4AF37]/35 bg-[#0D3B22] text-[#FDFBF7] py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3 pt-2">
              <Link
                ...
                className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-[#D4AF37] hover:text-[#C5A028] bg-white/5 border border-[#D4AF37]/30 hover:bg-white/10 rounded-xl px-4 py-2.5 transition-all w-fit shadow-sm"
              >
          ...
          <div className="space-y-4">
            ...
            <p className="text-[10px] text-[#8D7530] bg-white/5 border border-white/10 rounded-md p-2">
